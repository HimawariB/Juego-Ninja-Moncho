export default class GAME extends Phaser.Scene {
  ...
  create() {
   ...
   this.plataformas.create(10, 260, "plataforma");
   ...
   this.cursor=this.input.keyboard.createCursorKeys()
    ...
    this.scoreText = this.add.text(10, 50, `puntaje: ${this.score} / T: ${this.shapes["triangulo"].count} / C: ${this.shapes["cuadrado"].count} / D: ${this.shapes["diamante"].count}  / B: ${this.shapes["bomba"].count}`)
  ...
  onSecond() {
   ...
   onRecolectableBounced(recolectables, _plataformas){
    ...
    function collectNegative(player, negative) {
      negative.disableBody(true, true);
